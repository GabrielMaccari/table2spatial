...
def show_popup(message: str, msg_type: str = "notification", details: str | None = None, parent: QtWidgets.QMainWindow = None):
    """
...
def show_question_dialog(message: str, parent: QtWidgets.QMainWindow = None):
    """
